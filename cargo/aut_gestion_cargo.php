...
{
	$datos_consulta = pg_query("SELECT * FROM cargo order by cargo.codigo_cargo") or die("No se pudo realizar la consulta a la Base de datos");
?>
...
?>
			...
			<tr class="row0">
				<td  align="center">
					 <?php echo $resultados[codigo_cargo];?>
				</td>
				...
				<td align="center"> 
					<a onclick="return confirm('Esta seguro que desea eliminar el registro?');" href="index2.php?type=cargo_drop&codigo_cargo=<?php echo $resultados[codigo_cargo];?>" title="Pulse para eliminar el registro">
						<img border="0" src="images/borrar.png" alt="borrar">
					</a>
					<a href="index2.php?type=cargo_update&codigo_cargo=<?php echo $resultados[codigo_cargo];?>" title="Pulse para Modificar el Nivel de Acceso">
				...
				<tr align="center">
					<th colspan="6" align="center">
						<div id="cpanel">
							...
							<div style="float:right;">
								<div class="icon">
									<a href="index2.php?type=cargo_add">
