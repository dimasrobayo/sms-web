...
if (isset($_POST[save]))
{
	...
	if (($nombre_cargo==""))
	{
		...
		else
		{
			...
			$inserta_registro = pg_query("insert into cargo (nombre_cargo) values ('$nombre_cargo')") or die("NO SE PUEDE INSERTAR LA EMPRESA EN LA BASE DE DATOS.");	
...
<div align="center" class="centermain">
	<div class="main">  
		...
		<table class="adminform" border="0">
			<tr bgcolor="#55baf3">
				<th colspan="2">
					Registro de una nuevo Categor&iacute;a
				</th>
			</tr>
			...
			<tr width="15%">
				...
				<td width="85%">
					<input class="inputbox" type="text" id="nombre_cargo" name="nombre_cargo" maxlength="45" size="45"/>
