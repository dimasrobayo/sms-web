...
{
	$datos_consulta = pg_query("SELECT * FROM militantes, contactado, cargo, centro_votacion where cargo.codigo_cargo = militantes.codigo_cargo and centro_votacion.codigo_centro = militantes.codigo_centro and militantes.cedula_militante = contactado.cedula_militante order by militantes.cedula_militante") or die("No se pudo realizar la consulta a la Base de datos");
?>
...
?>
			...
			<tr class="row0">
				...
				<td align="center"> 
					<a onclick="return confirm('Esta seguro que desea eliminar el registro?');" href="index2.php?type=contactado_drop&cedula_militante=<?php echo $resultados[cedula_militante];?>" title="Pulse para eliminar el registro">
				...
				<tr align="center">
					<th colspan="9" align="center">
						<div id="cpanel">
							...
							<div style="float:right;">
								<div class="icon">
									<a href="fpdf/imprimir_contactado.php" target="_blank">
							...
							<div style="float:right;">
								<div class="icon">
									<a href="index2.php?type=contactado_add">
