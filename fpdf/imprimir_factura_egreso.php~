...
include ("conectar.php");
	...
	$inserta_registro = pg_query("insert into egreso (concepto_egreso, cedula_proveedor, monto_egreso) values ('$concepto_egreso', '$cedula_rif', '$monto_egreso') RETURNING Currval('egreso_codigo_egreso_seq')") or die('La consulta fall&oacute;: ' . pg_last_error());	
...
//consulta de filas
	$consulta = "SELECT * FROM egreso, proveedor where egreso.cedula_proveedor = proveedor.cedula_proveedor and egreso.codigo_egreso='$resultado_insert' order by egreso.codigo_egreso";
