...
<div align="center" class="centermain">
	<div class="main">  
		...
		<table class="adminform" border="0">
			...
			<input type="hidden" name="password" value="<?php echo $resultados1[nivel_acceso]; ?>"/>
			...
			<tr>
				...
				<td>
					<input value="<?php echo $resultados1[nombre_usuario]; ?>" class="inputbox" readonly="true" type="text" id="nombre" name="nombre" value="<?if ($error!="") echo $nombreapellido;?>" maxlength="25" size="25"/>
					<script type="text/javascript">
			...
			<tr>
				...
				<td>
					<input value="<?php echo $resultados1[apellido_usuario]; ?>" class="inputbox" readonly="true" type="text" id="apellido"  name="apellido" value="<?if ($error!="") echo $nombreapellido;?>" maxlength="25" size="25"/>
					<script type="text/javascript">
			...
			<tr>
				...
				<td>
					<input value="<?php echo $resultados1[usuario]; ?>" class="inputbox" readonly="true" type="text" id="usuario" name="usuario" value="<?if ($error!="") echo $nombreapellido;?>" maxlength="20" size="20"/>
					<script type="text/javascript">
