...
if (isset($_POST[save]))
{
	...
	$hora = $_POST['hora_registro'];
		...
		$passmd5=md5($pass);
		//se le hace el llamado a la funcion de insertar.	
		$inserta_registro = pg_query("SELECT update_usuario($cedula,'$nombre','$apellido','$usuario','$passmd5',$nivel, $status,'$fecha','$hora')") or die("NO SE PUEDE MODIFICAR LOS DATOS EN LA BASE DE DATOS.");		
	...
	<div class="main">  
		...
		<table class="adminform" border="0">
			...
			<tr>
				...
				<td>
					<input value="<?php echo $resultados1[nombre_usuario]; ?>" readonly="true" class="inputbox" type="text" id="nombre" name="nombre" value="<?if ($error!="") echo $nombreapellido;?>" maxlength="25" size="25"/>
					<script type="text/javascript">
			...
			<tr>
				...
				<td>
					<input value="<?php echo $resultados1[apellido_usuario]; ?>" readonly="true" class="inputbox" type="text" id="apellido"  name="apellido" value="<?if ($error!="") echo $nombreapellido;?>" maxlength="25" size="25"/>
					<script type="text/javascript">
			...
			<tr>
				...
				<td>
					<input value="<?php echo $resultados1[usuario]; ?>" readonly="true" class="inputbox" type="text" id="usuario" name="usuario" value="<?if ($error!="") echo $nombreapellido;?>" maxlength="20" size="20"/>
					<script type="text/javascript">
			...
			<tr>
				...
				<td>
					<input class="inputbox" id="password" name="password" type="password" maxlength="10" size="20"/>
					<script type="text/javascript">
			...
			<tr>
				...
				<td>
					<input class="inputbox" type="password" id="password1" name="confirm_password" value="<?if ($error!="") echo $nombreapellido;?>" maxlength="10" size="20"/>
					<script type="text/javascript">
