...
if (isset($_GET['codigo_centro'])){
	$datos_borrar= $_GET['codigo_centro'];

	//se le hace el llamado al archivo de conexion y luego se realiza el enlace.	
	require("conexion/aut_config.inc.php");
	$db_conexion=pg_connect("host=$sql_host dbname=$sql_db user=$sql_usuario password=$sql_pass");	

	$consulta = pg_query("SELECT * FROM centro_votacion") or die(pg_last_error());
	...
	else 
	{
		...
		$result_borrar=pg_query("SELECT drop_centro_votacion('$datos_borrar')") or die(pg_last_error());
		pg_close();
	}
}
?> 
...
<div align="center" class="centermain">
	<div class="main">  
		...
		<table class="adminform" border="0">
			<tr bgcolor="#55baf3">
				<th colspan="2">
					BORRAR CENTRO DE VOTACI&Oacute;N
				</th>
			</tr>
