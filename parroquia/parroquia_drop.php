...
if (isset($_GET['codigo_parroquia'])){
	...
	else 
	{
		...
		$result_borrar=pg_query("SELECT drop_parroquia($datos_borrar)") or die(pg_last_error());
		pg_close();
	}
}
?> 
