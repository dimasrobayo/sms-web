...
if (isset($_POST[save]))
{
	...
	if (($nombre_parroquia==""))
	{
		...
		else
		{
			...
			$inserta_registro = pg_query("insert into parroquia (nombre_parroquia) values ('$nombre_parroquia')") or die("NO SE PUEDE INSERTAR LA EMPRESA EN LA BASE DE DATOS.");	
...
<div align="center" class="centermain">
	<div class="main">  
		...
		<table class="adminform" border="0">
			<tr bgcolor="#55baf3">
				<th colspan="2">
					Registro de una nueva Parroquia
				</th>
			</tr>
			...
			<tr width="15%">
				...
				<td width="85%">
					<input class="inputbox" type="text" id="nombre_parroquia" name="nombre_parroquia" maxlength="45" size="45"/>
